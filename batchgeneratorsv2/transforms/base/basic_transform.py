...
class BasicTransform(abc.ABC):
    ...
    def apply(self, data_dict, **params):
        ...
        if data_dict.get('pseudo_segmentation') is not None:
            data_dict['pseudo_segmentation'] = self._apply_to_segmentation(data_dict['pseudo_segmentation'], **params)
    ...
    def apply_last(self, data_dict: dict) -> dict:
        return self.apply(data_dict, **self.last_params)
